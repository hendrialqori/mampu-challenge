...
function FieldLegend({
  ...
  return (
    <legend
      ...
      className={cn(
        "mb-2.5 font-medium data-[variant=label]:text-base data-[variant=legend]:text-sm",
        className
      )}
      {...props}
    />
...
function FieldTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="field-label"
      className={cn(
        "flex w-fit items-center gap-2 text-base/relaxed group-data-[disabled=true]/field:opacity-50",
        className
      )}
      {...props}
    />
